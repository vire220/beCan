...
public class GeneralSearchActivity extends AppCompatActivity implements OnBecanServerCompleted, BeaconRecyclerAdapter.ListItemClickListener {

    private static final String TAG = "GEN_SEARCH_ACTIVITY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new BeaconRecyclerAdapter(beaconList, this);
